...
#     interaction_term <- paste0(covariate, ":")
...
#         contrast.matrix <- cbind( "C1" = v.contrast)
#         # Interaction term for continuous variables
...
# 
# fit$design
# covariate_data<-metadata_filtered
# 
# limma_lm(fit,"Age_bin", metadata_filtered,   interaction = NULL)
