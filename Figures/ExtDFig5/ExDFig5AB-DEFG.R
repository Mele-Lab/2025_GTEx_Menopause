...
option<-options[2]
tissue<-"Ovary" #Chose ovary and breast for Extended Data Fig. B and C respectively
...
#Perform the enrichment for uterus factor 4, uterus factor 6, vagina factor 5 and ovary factor 7
