...
output ="/Paper_material/UMAPs/"

# Path to the folder containing the UMAP embeddings
umap_file = input + '//tiles_classification/umap_embeddings_voting_selected_tissues_filt.csv'

# Initialize an empty list to hold all dataframes
umap_data_list = []
with open(input +"//resources/clusters.yaml", "r") as f:
...
plt.tight_layout()
plt.show() 
plt.savefig(input+"/Paper_material/Post_review_analyses/4umap_main_fig_probs.png", format="png", dpi=300)
...
# Show the plot
plt.savefig("/X/RNAPath/tiles_classification/umap_top1_prob_4.png")
...
# Save plot
plt.savefig("/X/RNAPath/tiles_classification/umap_top1_prob_filtered_4.png")
