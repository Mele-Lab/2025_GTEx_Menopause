...
##A, G-N for proteomics comment the geom_point and don't show slope change
...
merged_df<- read.csv("BSC/05.CNN/RegressionModels/Mid_val_predictions.csv", row.names = "X")
m<-merged_df
...
#Gene expression and proteomics accuracies
ge_acc<-read.csv("X/Ole/paper/for_plotting/accuracy_file.csv")
