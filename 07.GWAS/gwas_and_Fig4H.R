...
AAM_EUR_GWAS <- read_excel("/X/Downloads/41588_2024_1798_MOESM4_ESM.xlsx", sheet = 19)
...
##3. Ovarian cysts
fem_repro <- fread(file.path(input_path, "Natalia/data/femrepro_natalia_ST8.tsv"), sep = "\t", header = TRUE, quote = "", stringsAsFactors = FALSE, skip = 1)
...
preprint_pcos <- read_excel(file.path("/X/Downloads/supptables_Loes_PCOSpreprint_media-2.xlsx"),
...
reprotraits<-fread(paste0(input_path, "/Natalia/data/repro_traits_melinda_updated_amh.tsv"))
dim(reprotraits) 
...
gene_annotation  <- fread(paste0(input_path, "/Laura/00.Data/gencode.v39.annotation.bed"))
head(new_unique)
...
# Define input path
input_path <- "/home/npujol/Desktop/GWAS_enrichment/projects/bsc83/Projects/GTEx_v8/"

# Define tissues and file paths
tissues <- c("Uterus", "Ovary", "Vagina", "Breast", "Myometrium")
file_paths <- c(paste0(input_path, "Laura/12.Tissues_substructures/DEA/DEA_v10/Uterus/all_cov_no_inter/Uterus_all_cov_no_inter_AGE_covariates_and_traits.results.rds"),
                paste0(input_path, "Laura/12.Tissues_substructures/DEA/DEA_v10/Ovary/all_cov_no_inter/Ovary_all_cov_no_inter_AGE_covariates_and_traits.results.rds"),
                paste0(input_path, "Laura/12.Tissues_substructures/DEA/DEA_v10/Vagina/all_cov_no_inter/Vagina_all_cov_no_inter_AGE_covariates_and_traits.results.rds"),
                paste0(input_path, "Laura/12.Tissues_substructures/DEA/DEA_v10/BreastMammaryTissue/all_cov_no_inter/BreastMammaryTissue_all_cov_no_inter_AGE_covariates_and_traits.results.rds"),
                paste0(input_path, "Laura/12.Tissues_substructures/DEA/DEA_v10/Uterus/all_cov_no_inter/Myometrium/Uterus_all_cov_no_inter_AGE_covariates_and_traits.results.rds")
)
